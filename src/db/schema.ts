...
export const projectSections = pgTable(
  ...
  (table) => [
    uniqueIndex("project_sections_project_order_unique").on(
      table.projectId,
      table.sortOrder,
    ),
  ],
...
export const experiences = pgTable(
  ...
  (table) => [
    uniqueIndex("experiences_sort_order_unique").on(table.sortOrder),
  ],
);
...
export const projectSectionsRelations = relations(
  projectSections,
  ({ one }) => ({
